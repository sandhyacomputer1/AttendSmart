...
//
//                // Draw footer
//                drawFooter(canvas, pageNumber, "Monthly Attendance Summary");
//
//                pdfDocument.finishPage(page);
//                pageNumber++;
//            }
...
//        String monthName = monthFormat.format(fromDate.getTime());
//
...
//        contPaint.setTextSize(10);
//
//        String continuationText = "Monthly Summary - Continued (Page " + pageNumber + ")";
//        canvas.drawText(continuationText, LEFT_MARGIN, yPosition, contPaint);
//
//        return yPosition + 20;
//    }
...
//        int headerY = yPosition + 17;
//
//        // Set column positions for monthly summary
//        int colNameX = LEFT_MARGIN;
//        int colPhoneX = colNameX + 200;
//        int colDeptX = colPhoneX + 120;
//        int colPresentX = colDeptX + 100;
//        int colAbsentX = colPresentX + 80;
//        int colLateX = colAbsentX + 70;
//        int colHalfDayX = colLateX + 80;
//        int colTotalX = colHalfDayX + 80;
//
//        // Draw vertical lines
...
//        canvas.drawText("Present Days", colPresentX + 5, headerY, headerTextPaint);
//        canvas.drawText("Absent Days", colAbsentX + 5, headerY, headerTextPaint);
//        canvas.drawText("Late Days", colLateX + 5, headerY, headerTextPaint);
//        canvas.drawText("Half Days", colHalfDayX + 5, headerY, headerTextPaint);
...
//            latePaint.setColor(Color.parseColor("#FF5722")); // Your company orange color
...
//            String subject = selectedReportType == 0 ?
//                    "Detailed Attendance Report - " + new SimpleDateFormat("dd MMM yyyy", Locale.getDefault()).format(new Date()) :
//                    "Monthly Attendance Summary - " + new SimpleDateFormat("MMM yyyy", Locale.getDefault()).format(fromDate.getTime());
//
...
// ==============================
    ...
    private int drawMonthlyTableHeader(Canvas canvas, int yPosition) {
        ...
        int colPresentX = colDeptX + 90;
        int colAbsentX = colPresentX + 70;
        int colLateX = colAbsentX + 60;
        int colHalfDayX = colLateX + 70;
        int colTotalX = colHalfDayX + 80;
